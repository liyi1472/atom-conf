    ...
    onExit(() => {
        ...
        if (fd !== null) {
            try {
                ...
                logger_1.default.error(error, `Got error while closing file descriptor of server.json, but the process is already exiting`);
            }
        }
        try {
            ...
            if (error.code !== 'ENOENT') {
                logger_1.default.error(error, `Got error unlinking server.json, but the process is already exiting`);
            }
        }
    });
