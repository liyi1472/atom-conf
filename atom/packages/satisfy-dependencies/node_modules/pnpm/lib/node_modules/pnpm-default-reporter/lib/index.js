...
function toOutput$(streamParser, opts) {
        ...
        streamParser['on']('data', (log) => {
            switch (log.name) {
                ...
                case 'pnpm:cli': // tslint:disable-line
                    ...
                    break;
                case 'pnpm:hook': // tslint:disable-line
    ...
    const outputs = reporterForClient_1.default(log$, isRecursive, opts.cmd, opts.width, opts.appendOnly, opts.throttleProgress, opts.cwd);
    if (opts.appendOnly) {
